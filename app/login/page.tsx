  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <form onSubmit={handleLogin} className="bg-white p-8 rounded-2xl shadow-sm border space-y-6">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="••••••••" />
          </div>
          ...
          <p className="text-center text-sm text-gray-600">
            Бүртгэл байхгүй юу? <Link href="/register" className="text-purple-600 font-medium hover:underline">Бүртгүүлэх</Link>
          </p>
        </form>
        <p className="text-center"><Link href="/" className="text-sm text-gray-500 hover:text-gray-700">Нүүр хуудас руу буцах</Link></p>
      </div>
    </div>
  );
}
